...
{
  new (message_memory) leo_with_interfaces::msg::Position(_init);
}

void Position_fini_function(void * message_memory)
{
  auto typed_message = static_cast<leo_with_interfaces::msg::Position *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Position_message_member_array[3] = {
  {
    ...
    offsetof(leo_with_interfaces::msg::Position, x_pos),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(leo_with_interfaces::msg::Position, y_pos),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(leo_with_interfaces::msg::Position, z_pos),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Position_message_members = {
  "leo_with_interfaces::msg",  // message namespace
  "Position",  // message name
  3,  // number of fields
  sizeof(leo_with_interfaces::msg::Position),
...
get_message_type_support_handle<leo_with_interfaces::msg::Position>()
{
  return &::leo_with_interfaces::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, leo_with_interfaces, msg, Position)() {
  return &::leo_with_interfaces::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
